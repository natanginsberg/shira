...
public class ShareOptionsUI {
    ...
    public ShareOptionsUI(View view, UserInfo user, boolean cameraOn) {
        this.view = view;
        this.user = user;
    ...
    public void openShareOptions(Context context, SingActivityUI.ShareListener shareListener) {
        ...
        if (!cameraOn)
            setFooterLanguageWithoutVideo(context);
//        setFreeShares(context);
    ...
    private void setFooterLanguageWithoutVideo(Context context) {
        ((TextView) thirdPopupView.findViewById(R.id.no_video_send)).setText(context.getResources().getString(R.string.recorded_without_video));
    }
...
//            thirdPopup.dismiss();
        ...
        if (cameraOn)
            thirdPopupView.findViewById(R.id.no_video_send).setOnClickListener(view -> {
                if (video) {
                    ...
                    video = true;
                    ((TextView) thirdPopupView.findViewById(R.id.header)).setText(context.getResources().getString(R.string.share));
    ...
    private void headerWithoutVideo(Context context) {
        ...
        headerText.setText(context.getResources().getString(R.string.share) + " " + context.getResources().getString(R.string.no_video_share));
...
//    }
    ...
    public void hideRecordingBeingSaved() {
        thirdPopupView.findViewById(R.id.recording_being_saved).setVisibility(View.INVISIBLE);
    }
}
